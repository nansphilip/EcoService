...
const getQuantityCountCached = cache(
    async (stringParams: string): Promise<CountQuantityResponse> => {
 ...
 */
export const GET = async (request: NextRequest): Promise<NextResponse<CountQuantityResponse>> => {
    try {
