...
const getVerificationCountCached = cache(
    async (stringParams: string): Promise<CountVerificationResponse> => {
 ...
 */
export const GET = async (request: NextRequest): Promise<NextResponse<CountVerificationResponse>> => {
    try {
