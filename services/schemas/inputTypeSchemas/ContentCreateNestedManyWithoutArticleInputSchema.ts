...
export const ContentCreateNestedManyWithoutArticleInputSchema: z.ZodType<Prisma.ContentCreateNestedManyWithoutArticleInput> = z.object({
...
export default ContentCreateNestedManyWithoutArticleInputSchema;
