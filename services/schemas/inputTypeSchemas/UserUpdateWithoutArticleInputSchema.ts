...
export const UserUpdateWithoutArticleInputSchema: z.ZodType<Prisma.UserUpdateWithoutArticleInput> = z.object({
...
export default UserUpdateWithoutArticleInputSchema;
