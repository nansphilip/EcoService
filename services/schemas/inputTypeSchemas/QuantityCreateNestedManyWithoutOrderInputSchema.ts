...
export const QuantityCreateNestedManyWithoutOrderInputSchema: z.ZodType<Prisma.QuantityCreateNestedManyWithoutOrderInput> = z.object({
...
export default QuantityCreateNestedManyWithoutOrderInputSchema;
