...
export const ContentUpdateManyWithoutArticleNestedInputSchema: z.ZodType<Prisma.ContentUpdateManyWithoutArticleNestedInput> = z.object({
...
export default ContentUpdateManyWithoutArticleNestedInputSchema;
