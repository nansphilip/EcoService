...
export const UserUncheckedCreateWithoutAdressInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutAdressInput> = z.object({
...
export default UserUncheckedCreateWithoutAdressInputSchema;
