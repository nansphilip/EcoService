...
export const QuantityCreateNestedManyWithoutProductInputSchema: z.ZodType<Prisma.QuantityCreateNestedManyWithoutProductInput> = z.object({
...
export default QuantityCreateNestedManyWithoutProductInputSchema;
