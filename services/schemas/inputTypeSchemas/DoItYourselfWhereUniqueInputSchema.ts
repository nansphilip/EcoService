...
export const DoItYourselfWhereUniqueInputSchema: z.ZodType<Prisma.DoItYourselfWhereUniqueInput> = z.object({
  id: z.string()
})
.and(z.object({
...
export default DoItYourselfWhereUniqueInputSchema;
