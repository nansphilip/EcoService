...
import { QuantityUncheckedUpdateManyWithoutOrderNestedInputSchema } from './QuantityUncheckedUpdateManyWithoutOrderNestedInputSchema';
...
export const OrderUncheckedUpdateWithoutUserInputSchema: z.ZodType<Prisma.OrderUncheckedUpdateWithoutUserInput> = z.object({
  ...
  Quantity: z.lazy(() => QuantityUncheckedUpdateManyWithoutOrderNestedInputSchema).optional()
}).strict();
