...
export const QuantityUpdateArgsSchema: z.ZodType<Prisma.QuantityUpdateArgs> = z.object({
  select: QuantitySelectSchema.optional(),
  include: z.lazy(() => QuantityIncludeSchema).optional(),
  data: z.union([ QuantityUpdateInputSchema,QuantityUncheckedUpdateInputSchema ]),
  where: QuantityWhereUniqueInputSchema,
}).strict() ;

export default QuantityUpdateArgsSchema;
