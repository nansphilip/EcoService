...
export const DoItYourselfUpdateArgsSchema: z.ZodType<Prisma.DoItYourselfUpdateArgs> = z.object({
  select: DoItYourselfSelectSchema.optional(),
  include: z.lazy(() => DoItYourselfIncludeSchema).optional(),
  data: z.union([ DoItYourselfUpdateInputSchema,DoItYourselfUncheckedUpdateInputSchema ]),
  where: DoItYourselfWhereUniqueInputSchema,
}).strict() ;

export default DoItYourselfUpdateArgsSchema;
