...
export const DoItYourselfCreateArgsSchema: z.ZodType<Prisma.DoItYourselfCreateArgs> = z.object({
  select: DoItYourselfSelectSchema.optional(),
  include: z.lazy(() => DoItYourselfIncludeSchema).optional(),
  data: z.union([ DoItYourselfCreateInputSchema,DoItYourselfUncheckedCreateInputSchema ]),
}).strict() ;

export default DoItYourselfCreateArgsSchema;
